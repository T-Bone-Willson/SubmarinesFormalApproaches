...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#edefb85d#;
   ...
   u00114 : constant Version_32 := 16#69955cf7#;
   pragma Export (C, u00114, "submarinesubsystemB");
   u00115 : constant Version_32 := 16#b1663e39#;
   ...
   --  ada.text_io%s
   --  ada.text_io%b
   --  submarinesubsystem%s
   --  submarinesubsystem%b
   --  main%b
